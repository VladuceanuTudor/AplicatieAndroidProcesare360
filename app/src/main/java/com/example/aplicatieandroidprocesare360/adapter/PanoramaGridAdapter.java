...
public class PanoramaGridAdapter extends BaseAdapter {

    private final Context context;
    private List<Panorama> items;
    private final SimpleDateFormat sdf = new SimpleDateFormat("dd.MM.yyyy", Locale.getDefault());

    public PanoramaGridAdapter(Context context, List<Panorama> items) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = LayoutInflater.from(context)
                    .inflate(R.layout.grid_item_panorama, parent, false);
    ...
    static class ViewHolder {
        ...
        TextView  tvTitle, tvDate, tvStatusDot;
